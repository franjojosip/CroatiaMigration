    ...
    <div id="infoContainer">
        <div class="row">
            ...
            <div class="column" id="aboutGraph">
                ...
                <p>
                    <b>Doseljenim</b>, odnosno <b>odseljenim</b> stanovništvom smatra se stanovništvo koje je
                    promijenilo uobičajeno
                    mjesto stanovanja na području Republike Hrvatske ili koje je promijenilo uobičajenu državu
                    stanovanja na
                    razdoblje koje je ili se očekuje da će biti dugo najmanje godinu dana.
                </p>
                <p>
                    Podaci o migracijama obuhvaćaju državljane Republike Hrvatske i strance na privremenome ili stalnom
                    boravku u Republici Hrvatskoj.
                </p>
                <p>
                    Statistika unutarnje migracije stanovništva prikuplja i obrađuje podatke o tijekovima migracije
                    stanovništva unutar zemlje, tj. o broju i strukturi osoba koje su promijenile mjesto stanovanja
                    unutar
                    Republike Hrvatske u određenoj kalendarskoj godini.
                </p>
                <p>
                    Statistika vanjske migracije stanovništva prikuplja i obrađuje podatke o tijekovima vanjske
                    migracije,
                    tj. o broju i strukturi osoba koje su promijenile uobičajenu državu stanovanja u određenoj
                    kalendarskoj
                    godini.
                </p>
            </div>
